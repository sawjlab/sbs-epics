...
#include "caen1527Version.h"

/* must be last include */
#include "epicsExport.h"

const char version[] = caen1527VERSION;
...
static lsidset devcaen1527Version = {
    5, NULL, NULL, NULL, NULL, read_string
};
epicsExportAddress(dset,devcaen1527Version);
